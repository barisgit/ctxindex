...
The walkthrough used a fresh `mktemp -d` sandbox with `HOME`, `XDG_CONFIG_HOME`, `XDG_DATA_HOME`, `XDG_CACHE_HOME`, and `XDG_STATE_HOME` pointed inside it. A sibling `mktemp -d` content directory contained three text files with distinct words (`quokka`, `nebula`, `zephyr`). Raw capture: `docs/RELEASE-V1/run-logs/cli-walkthrough.md`.
...
### `bun run typecheck`
Exit code: `0`; duration: 1s; raw log: `docs/RELEASE-V1/run-logs/01-bun-run-typecheck.log`
```text
$ tsgo --noEmit -p tsconfig.base.json
```

### `bun run lint`
Exit code: `0`; duration: 0s; raw log: `docs/RELEASE-V1/run-logs/02-bun-run-lint.log`
```text
$ biome check .
...
### `bun test`
Exit code: `0`; duration: 18s; raw log: `docs/RELEASE-V1/run-logs/03-bun-test.log`
```text
...
### `bun run test:e2e`
Exit code: `0`; duration: 34s; raw log: `docs/RELEASE-V1/run-logs/04-bun-run-test-e2e.log`
```text
...
Exit code: `0`; duration: 1s; raw log: `docs/RELEASE-V1/run-logs/05-bun-run-test-integration.log`
```text
...
Exit code: `0`; duration: 58s; raw log: `docs/RELEASE-V1/run-logs/06-bash-scripts-verify-ci.sh.log`
```text
...
Exit code: `0`; duration: 0s; raw log: `docs/RELEASE-V1/run-logs/07-bash-scripts-verify-bun-link.sh.log`
```text
...
Exit code: `0`; duration: 0s; raw log: `docs/RELEASE-V1/run-logs/08-bash-scripts-verify-env-loader.sh.log`
```text
...
Exit code: `0`; duration: 1s; raw log: `docs/RELEASE-V1/run-logs/09-bash-scripts-verify-network-egress.sh.log`
```text
...
Exit code: `0`; duration: 0s; raw log: `docs/RELEASE-V1/run-logs/10-bash-scripts-verify-no-prompts-static.sh.log`
```text
...
- `git diff --name-status main..HEAD` at `docs/RELEASE-V1/run-logs/git-diff-name-status.txt` for committed branch shape against `main`.
- `git status --short` at `docs/RELEASE-V1/run-logs/git-status-short.txt` for current worktree shape, including uncommitted v1 files and this report directory.
