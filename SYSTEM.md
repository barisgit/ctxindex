...
>
> **Sources consulted:** `README.md`; `CONTEXT.md`; all 18 capability specs and all 17 sidecars present on 2026-07-18 (`core-model` has none); the `agent-orientation-guidance` change's CLI-surface and search-routing delta specs; all four delta specs in `separate-sync-warning-error-accounting`; decisions D1–D22 in `docs/design/2026-07-13-context-access-layer.md`; `.agents/skills/repo-development/SKILL.md`; and current CLI help/registry output. Section 13 is the full index.
