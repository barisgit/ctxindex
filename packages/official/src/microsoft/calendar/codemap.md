# packages/official/src/microsoft/calendar/
...
- Registered by `packages/official/src/builtins.ts` and exported with its config schema through `packages/official/src/index.ts`.
