# packages/official/src/microsoft/mailbox/
...
- Registered by `packages/official/src/builtins.ts` and exported through `packages/official/src/index.ts`; core source/search/retrieve/artifact and Action services invoke it through Extension SDK contexts.
