...
2. Application composition loads config plus built-in, explicit-path, and installed Catalog Extensions, opens storage, constructs typed secret, OAuth client, Account/Grant, Realm, and Source services, then builds search, retrieval, Artifact, and Action workflows.
