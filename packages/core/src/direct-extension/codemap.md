...
Exported as `@ctxindex/core/direct-extension`; the CLI lifecycle handler supplies runtime registries, local OAuth App identities, and Source bindings. `extension/loader.ts` consumes valid records for offline activation.
