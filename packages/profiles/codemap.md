...
Defines ctxindex's bundled provider-neutral Profile vocabularies in the private `@ctxindex/profiles` workspace package: `calendar.event@1`, `chat.message@1`, `mail.message@1`, and `file@1`, with their schemas, draft input unions, Ref/text/reply helpers, and public types.
