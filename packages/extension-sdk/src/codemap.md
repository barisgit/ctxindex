...
1. An extension author defines Provider policy, optional OAuth App registrations, schema-backed Profiles, and capability-constrained Adapters, then groups any root definitions with `defineExtension`.
