...
Owns the shared Microsoft identity provider definition and Microsoft Graph-backed Adapter implementations.
...
- `mailbox/` implements the federated Outlook mailbox Adapter over Microsoft Graph; see `packages/adapters/src/microsoft/mailbox/codemap.md`.
...
3. Authenticated mailbox operation contexts then cross the Graph boundary through the child module's transport helpers.
