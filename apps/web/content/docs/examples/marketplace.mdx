...
ctxindex extension catalog show community community.mail --format json
```
...
```sh
ctxindex extension catalog search mail --no-refresh --format json
ctxindex extension catalog list --no-refresh --format json
ctxindex extension catalog show community --no-refresh --format json
```
...
```sh
ctxindex extension install catalog community community.mail --format json
...
```sh
ctxindex extension uninstall community.mail --format json
ctxindex extension catalog remove community --format json
```
