...
| **Grant** | The Account's stable normalized permission set and secret references. Reauthorization updates it in place. |
...
- one Client can authorize multiple Accounts for its provider;
