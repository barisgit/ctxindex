...
Client ──> Account ──> Grant ──explicit binding──> Source
```
...
- Source Adapters own provider authentication, transport, normalization, and declared operations;
- Extensions bundle Profiles and Source Adapters without adding commands.
