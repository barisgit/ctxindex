...
- The package follows a layered CLI architecture: executable shim -> citty composition root -> parser/handler/workflow modules -> core services -> output adapters.
...
3. `runCli` dispatches through the command tree; handlers parse arguments, load dependencies and definitions, invoke core behavior, and format output.
