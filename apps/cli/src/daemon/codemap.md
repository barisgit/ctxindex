...
- Detached launch uses a strict infrastructure/test environment allowlist; Provider and arbitrary Extension credential variables never enter the long-lived daemon environment. Account stream settlement or rejection always aborts interactive prompt input before cleanup.
