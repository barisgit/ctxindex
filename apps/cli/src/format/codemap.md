...
- Catalog formatters render deterministic persisted pins, entries, install/uninstall provenance, and snapshot age. Direct formatters expose credential-free requested targets, exact immutable provenance with install/update times, unavailable persisted pins, and forced-removal data-preservation semantics.
