# OAuth Client Management Specification

## Purpose
Define persisted provider-scoped OAuth client configuration, safe credential import, non-sensitive inventory and removal, and deterministic Account authorization selection.
