...
- [x] 1.1 Add focused argument and CLI e2e tests for `client list --format json`, exact safe metadata shape, empty `[]`, provider-then-label determinism, secret redaction, and unchanged text output; run them first to establish the current failure.
