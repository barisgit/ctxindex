...
The addition is compatible with existing pre-alpha payloads because `communication.message@1` and core traversal contracts remain unchanged. The package gains additive root and `./chat-message` exports.
