...
- [x] 1.5 Align canonical generic-storage behavior and implementation doctrine with on-demand descriptor derivation and download-only cache metadata writes.
