...
Depends: C5, C8
Status: pass — provider-owned default v1.0 delta and named-calendar complete scans, exact Source-scoped retrieval, cross-provider Realm/search/get/window isolation, `Calendars.Read`, and no beta/write routes pass focused/full/compiled gates and independent review; see `work/slice-9-microsoft-calendar-gate.md`
...
Status: in-progress — Slice 10 relocated product, recursive security/interface, CI/full/D3/strict gates and corrected independent reviews pass; isolated Microsoft state and exact registration/read/Draft plan are prepared and paused before consent, while live confirmation, final drift, and fresh-context QA remain; see `work/slice-10-product-workflow-gate.md` and `work/microsoft-human-checkpoint-plan.md`
