...
- Layered boundaries keep CLI presentation separate from provider-neutral core services and Profiles: calendar and mail Profiles own shared vocabulary and Draft Action contracts, while Adapters own provider-specific Google, Microsoft Graph, and filesystem I/O.
